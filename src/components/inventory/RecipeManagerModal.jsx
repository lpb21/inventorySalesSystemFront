...
import { X, BookOpen, Trash2, Scissors, Package, Plus, Edit } from 'lucide-react'
 ...
 * Lista, crea, edita y borra recetas.
 */
function RecipeManagerModal({ products, onClose, addToast }) {
  ...
  return (
    <>
            ...
            {isLoading ? (
              ...
              <div style={{ padding: '32px', textAlign: 'center', color: 'var(--text-secondary)' }}>
                ...
                <p style={{ fontSize: '13px' }}>
                  Crea una para pre-llenar los cortes al despiezar.
                </p>
              </div>
            ) : (
      ...
      {/* Formulario de crear/editar (encima del gestor) */}
      {showForm && (
        <RecipeFormModal
          products={products}
