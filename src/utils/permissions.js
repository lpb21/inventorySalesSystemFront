...
export const PERMISSIONS = {
  viewer:     { canEditProducts: false, canDeleteProducts: false, canManageCategories: false, canManageSuppliers: false, canDiscount: false, canViewFullReports: false, canViewCosts: false, canAccessSettings: false, canManageUsers: false, canViewCreditAccounts: false },
  ...
  supervisor: { canEditProducts: true,  canDeleteProducts: false, canManageCategories: false, canManageSuppliers: false, canDiscount: true,  canViewFullReports: true,  canViewCosts: true,  canAccessSettings: false, canManageUsers: false, canViewCreditAccounts: true },
